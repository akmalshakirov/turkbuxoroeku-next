...
const textReviews: ITextReviewsProp[] = [
    {
        ...
        date: "15.07.2024",
        description:
            "Мне проводили операцию по выравниванию перегородки и прижигание слизистой оз за медикаментозного ринита. Мой лечащий доктор Анна Григорьевна была со мной, как говорится, на волне, хотя я тот ещё прив...",
    },
    {
        id: 2,
        author: "Марина",
